  ...
  return (
    <>
      <div className="content">
        ...
        <motion.div className="home flex flex-col" initial={{ opacity: 0 }}
  ...
  viewport={{ once: true }}>
          ...
          <div className="home__container">
            <div className="detail">
              <h1 className="home__title">Hi,I'm <span className="home__name">Hout Ankeara</span></h1>
              ...
              <div className="btn">
                  ...
                  <Link to="#" onClick={copyEmailToClipboard} className="btn__copy">
                    ...
                    {buttonText} {/* Display button text dynamically */}
                  </Link>

                  {showAlert && (
                    <aside className="fixed bottom-4 end-4 z-50 flex items-center justify-center gap-4 rounded-lg bg-black px-5 py-3 textWhite">
          ...
          <div className="project__ex">
            <div className="status-container">
              ...
              <a href="https://my-templatedesign.vercel.app/" target="blank" className="btn__hire">
